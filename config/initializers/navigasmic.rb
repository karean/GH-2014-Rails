Navigasmic.setup do |config|
  ...
  config.semantic_navigation :primary do |n|
    n.group 'Primary' do
      n.item 'About', proc { about_path } do
        n.group 'Sub_About' do
          n.item 'About Us Home', proc { about_path}
          n.item 'Our Story', proc { story_path}
        end
      end
      n.item 'Leadership', proc { leadership_path} do
        n.group 'Sub_Leadership' do
          n.item 'Leadership Home', proc { leadership_path }
          n.item 'A Word From Our Founders', proc { founders_path }
          n.item 'Board of Directors', proc { directors_path }
          n.item 'Executive Committee', proc { executive_path}
        end
      end
      n.item 'School', proc { school_path} do
        n.group 'Sub_School' do
          n.item 'School Home', proc { school_path }
          n.item 'Headmistress Harriet', proc { headmistress_path }
          n.item 'Teachers', proc { teachers_path }
          n.item 'Students', proc { students_path }
          n.item 'Facilities', proc { facilities_path }
        end
      end
      n.item 'Projects', proc { projects_path} do
        n.group 'Sub_Projects' do
          n.item 'Projects Home', proc { projects_path }
          n.item 'Playground', proc {playground_path }
          n.item 'Curriculum Development', proc { curriculum_path }
          n.item 'Green Hope Primary: A Dream for the Future', proc { primary_path }
        end
      end
      n.item 'Volunteer', proc { volunteer_path} do
        n.group 'Sub_Volunteer' do
          n.item 'Volunteer Home', proc { volunteer_path }
          n.item 'Trip Experience', proc { trip_path }
          n.item 'Featured Volunteer', proc { featured_volunteers_path}
          n.item 'Get Involved', proc { get_involved_path}
        end
      end
      n.item 'Donate', proc { donate_path } do
        n.group 'Sub_Donate' do
          n.item 'Donate Home', proc { donate_path }
          n.item 'Our Partners', proc { partners_path }
        end
      end
    end
  end
